...
export default function ShipmentForm({ id,load }: { id?: string; load?:boolean }) {
  ...
  return (
    <div className="container mx-auto p-8">
      <div className="border border-gray-500 p-8 rounded-2xl">
        ...
        {
          id ? <div className="text-center">Order ID : {shipmentItemDetail?.order_id}</div> : null
        }
